...
-   Displays a navigation bar that horizontally collapses and expands. Built using HTML5, CSS3, SASS, and JavaScript. Other features utilized include a custom CSS reset and Google fonts.
...
-   User can click on the hamburger or X icon to either horizontally expand or collapse the navigation bar.
