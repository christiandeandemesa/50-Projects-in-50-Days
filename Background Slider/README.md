...
-   Displays an image carousel that also changes the background. Built using HTML5, CSS3, SASS, and JavaScript. Other features utilized include a custom CSS reset, Font Awesome icons, and Google fonts.
...
-   User can click either arrow button to cycle through the images.
-   User can view a larger version of each image in the background.
