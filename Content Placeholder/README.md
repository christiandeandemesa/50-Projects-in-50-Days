...
- Displays a loading effect for the contents of a card. Built using HTML5, CSS3, SASS, and JavaScript. Other features utilized include a custom CSS reset, and animations.
