...
- Displays a large cup that can be filled relative to how many small cups are filled. Built using HTML5, CSS3, SASS, and JavaScript. Other features utilized include a custom CSS reset.
