...
-   Displays multiple boxes that slide into view when the user scrolls. Built using HTML5, CSS3, SASS, and JavaScript. Other features utilized include a custom CSS reset and Google fonts.
